        ...
        <div data-off-canvas="mobile-slidebar left overlay" style="background-color:white; color:black;">
            <a class="navbar-brand scroll" href="https://automarketpanama.com/public/"><img width="200" class="scroll-logo" src="<?php echo BASEURL; ?>media/logo/LOGO-WEB-AUTOMARKET.png" alt="logo"></a>


            <ul class="navbar-nav">
                <li class="nav-item active"><a class="nav-link" href="/public/" style="color: black !important;">Inicio<span class="sr-only" ></span></a></li>
                <li class="nav-item "><a class="btn btn-primary" href="https://automarketpanama.com/public/listing" >Inventario</a>
                    ...
                    <ul>
                        ...
                        <?php while ($tipo = $tipo_carro->fetch_assoc()) { ?>
                            <a class="dropdown-item" href="https://automarketpanama.com/public/listing?tipo_auto=<?php echo $tipo['CarType']; ?>&menu=1" style="color: black !important;"><?php echo $tipo['CarType']; ?></a>
                        <?php } ?>
                    </ul>
                ...
                <li class="nav-item"><a class="nav-link" href="/public/about" style="color: black !important;"> Nuestro Equipo</a></li>
                <!--
                ...
                <li class="nav-item"><a class="nav-link" href="/public/contact" style="color: black !important;">Contáctanos</a></li>
            </ul>
        ...
        <div data-canvas="container">
            ...
            <header class="header">
                ...
                <div class="top-bar d-none d-xl-block">
                    ...
                    <div class="container">
                        <div style="position: absolute; z-index:99; margin-left:-60px; margin-top:10px;"><a class="" href="https://automarketpanama.com/public/"><img width="200" class="normal-logo" src="<?php echo BASEURL; ?>media/logo/LOGO-WEB-AUTOMARKET.png" alt="logo"></a></div>
                        <div class="row">
                            <div class="col offset-2">
                                <div class="top-bar__inner row justify-content-between align-items-center">
                                    ...
                                    </ul><a class="btn btn-primary btn-sm col-auto" href="https://automarketpanama.com/public/listing" style="display:block; margin-right: -60px; "><i class="ic icon-list"></i> Ver Inventario</a>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <nav class="navbar navbar-expand-md justify-content-end" id="nav" style="z-index: 999;">
                                    <ul class="yamm main-menu navbar-nav">
                                        ...
                                        <li class="nav-item dropdown">
                                            <a class="nav-link dropdown-toggle" id="navbarDropdown2" href="/public/listing" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Inventario</a>
                                            <div class="dropdown-menu" aria-labelledby="navbarDropdown2">
                                                <a class="dropdown-item" href="https://automarketpanama.com/public/listing">Todos</a>
                                            <?php while ($tipo = $tipo_carro2->fetch_assoc()) { ?>
                                                <a class="dropdown-item" href="https://automarketpanama.com/public/listing?tipo_auto=<?php echo $tipo['CarType']; ?>&menu=1"><?php echo $tipo['CarType']; ?></a>
                                            <?php } ?>
                                                
                                            </div>
                                        </li>
                                        <li class="nav-item"><a class="nav-link" href="/public/financiamiento">Financiamiento</a></li>
                                        <li class="nav-item"><a class="nav-link" href="/public/about">Nuestro Equipo</a></li>
                                        <li class="nav-item"><a class="nav-link" href="/public/contact">Contáctanos</a></li>
                                    </ul><a id="todo_inventario" class="btn btn-primary btn-sm col-auto" href="https://automarketpanama.com/public/listing" style=""><i class="ic icon-list"></i> Ver Inventario</a>
                                </nav>

                               
                                    <form id="form_buscado" class="form-buscador" method="get" action="https://automarketpanama.com/public/listing">
