                ...
                <li class="nav-item "><a class="btn btn-primary" href="https://automarketpanama.com/public/inventario">Inventario</a>
                    ...
                    <ul>
                        <?php while ($tipo = $tipo_carro->fetch_assoc()) { ?>
                            <a class="dropdown-item" href="https://automarketpanama.com/public/inventario?tipo_auto=<?php echo $tipo['CarType']; ?>&menu=1" style="color: black !important;"><?php echo $tipo['CarType']; ?></a>
                        <?php } ?>
                    </ul>
                                    ...
                                    <ul class="yamm main-menu navbar-nav">
                                        ...
                                        <li class="nav-item dropdown">
                                            ...
                                            <?php while ($tipo = $tipo_carro2->fetch_assoc()) { ?>
                                                <a class="dropdown-item" href="https://automarketpanama.com/public/inventario?tipo_auto=<?php echo $tipo['CarType']; ?>&menu=1"><?php echo $tipo['CarType']; ?></a>
                                            <?php } ?>
