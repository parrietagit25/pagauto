          ...
          <div class="container">
              <div class="row justify-content-center align-items-center">
                  <div class="col-lg-8 col-md-10 text-center" style="margin-top:40px;">
                      ...
                      <a class="btn btn-sm btn-primary" href="https://automarketpanama.com/financiamiento">Ver Requisitos</a>
                  </div>
                  ...
                  if ($result->num_rows > 0) {
                      ...
                      while ($row = $result->fetch_assoc()) {
                        ...
                        ?>
                          ...
                          <a href="https://automarketpanama.com/detail?placa=<?php echo $precios_similares['LicensePlate']; ?>">
