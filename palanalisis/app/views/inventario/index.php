                ...
                <div class="col offset-lg-3">
                  <div class="b-title-page__wrap">
                    ...
                    <nav aria-label="breadcrumb">
                      <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="https://automarketpanama.com/">Inicio</a></li>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-12 col-md-6 text-center">
                        ...
                        <a class="b-bnr-3__btn btn btn-primary" href="https://automarketpanama.com/inventario">Aplica aquí</a>
                    </div>
                </div>
            </div>
        </section>
