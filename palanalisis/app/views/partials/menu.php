        ...
        <div data-off-canvas="mobile-slidebar left overlay" style="background-color:white; color:black;">
            <a class="navbar-brand scroll" href="https://automarketpanama.com/"><img width="200" class="scroll-logo" src="<?php echo BASEURL; ?>media/logo/LOGO-WEB-AUTOMARKET.png" alt="logo"></a>
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item active"><a class="nav-link" href="/" style="color: black !important;">Inicio<span class="sr-only" ></span></a></li>
                <li class="nav-item "><a class="btn btn-primary" href="https://automarketpanama.com/inventario" >Inventario</a>
                    ...
                    <ul>
                        ...
                        <?php while ($tipo = $tipo_carro->fetch_assoc()) { ?>
                            <a class="dropdown-item" href="https://automarketpanama.com/inventario?tipo_auto=<?php echo $tipo['CarType']; ?>&menu=1" style="color: black !important;"><?php echo $tipo['CarType']; ?></a>
                        <?php } ?>
                    </ul>


                </li>
                <li class="nav-item"><a class="nav-link" href="/financiamiento" style="color: black !important;">Financiamiento</a></li>
                <li class="nav-item"><a class="nav-link" href="/nuestro-equipo" style="color: black !important;"> Nuestro Equipo</a></li>
                <!--
                ...
                <li class="nav-item"><a class="nav-link" href="/contacto" style="color: black !important;">Contáctanos</a></li>
            </ul>
        ...
        <div data-canvas="container">
            ...
            <header class="header">
                ...
                <div class="top-bar d-none d-xl-block">
                    ...
                    <div class="container">
                        <div style="position: absolute; z-index:99; margin-left:-60px; margin-top:10px;"><a class="" href="https://automarketpanama.com/"><img width="200" class="normal-logo" src="<?php echo BASEURL; ?>media/logo/LOGO-WEB-AUTOMARKET.png" alt="logo"></a></div>
                        <div class="row">
                            <div class="col offset-2">
                                <div class="top-bar__inner row justify-content-between align-items-center">
                                    ...
                                    </ul><a class="btn btn-primary btn-sm col-auto" href="https://automarketpanama.com/inventario" style="display:block; margin-right: -60px; "><i class="ic icon-list"></i> Ver Inventario</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="container">
                        <div class="row align-items-center">
                            <div class="col-lg-2 col-auto">
                                <a class="navbar-brand scroll" href="https://automarketpanama.com/">
                            ...
                            <div class="col-lg-auto col">
                                <div class="header-contactos d-none d-md-block d-lg-none d-xl-block"><!--<i class="ic text-primary"> <img width="30" style="margin-top:-20px;" src="<?php //echo BASEURL; ?>media/icons/phone.png" alt=""></i> <span class="header-contactos__inner">Contáctanos<a class="header-contactos__number" href="tel:+17553028549">+507 279-2789 | +507 6959-0953</a></span>--></div>
                                ...
                                <nav class="navbar navbar-expand-md justify-content-end" id="nav" style="z-index: 999;">
                                    <ul class="yamm main-menu navbar-nav">
                                        ...
                                        <li class="nav-item dropdown">
                                            <a class="nav-link dropdown-toggle" id="navbarDropdown2" href="/inventario" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Inventario</a>
                                            <div class="dropdown-menu" aria-labelledby="navbarDropdown2">
                                                <a class="dropdown-item" href="https://automarketpanama.com/inventario">Todos</a>
                                            <?php while ($tipo = $tipo_carro2->fetch_assoc()) { ?>
                                                <a class="dropdown-item" href="https://automarketpanama.com/inventario?tipo_auto=<?php echo $tipo['CarType']; ?>&menu=1"><?php echo $tipo['CarType']; ?></a>
                                            <?php } ?>
                                                
                                            </div>
                                        </li>
                                        <li class="nav-item"><a class="nav-link" href="/financiamiento">Financiamiento</a></li>
                                        <li class="nav-item"><a class="nav-link" href="/nuestro-equipo">Nuestro Equipo</a></li>
                                        <li class="nav-item"><a class="nav-link" href="/contacto">Contáctanos</a></li>
                                    </ul><a id="todo_inventario" class="btn btn-primary btn-sm col-auto" href="https://automarketpanama.com/inventario" style=""><i class="ic icon-list"></i> Ver Inventario</a>
                                </nav>

                               
                                    <form id="form_buscado" class="form-buscador" method="get" action="https://automarketpanama.com/inventario">
