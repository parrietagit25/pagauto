    ...
    <div class="container">
        <div class="row">
            <div class="col-12">
                <div class="text-center">
                    <div class="footer-logo"><a class="footer-logo__link" href="home.html"><img width="250" class="img-responsive" src="<?php echo BASEURL; ?>media/logo/LOGO-WEB-AUTOMARKET-BLANCO.png" alt="Logo"></a></div>
        ...
        <div class="row">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <ul class="footer-list list-unstyled">
                            <li><a href="https://automarketpanama.com/home">Inicio</a></li>
                            <li><a href="https://automarketpanama.com/inventario">Inventario</a></li>
                            <li><a href="https://automarketpanama.com/nuestro-equipo">Sobre Nosotros</a></li>
                            <li><a href="https://automarketpanama.com/contacto">Contáctanos</a></li>
                        </ul>
                        </section>
                    </div>
                    <div class="col-lg-6">
            ...
            <div class="col-md-4">
                ...
                <div class="footer-contacts">
                    <br>
                    <div class="footer-contacta__item"><a href="https://automarketpanama.com/politicas_devol" target="_blank" style="color:gray;">Política de devolución </a></div>
                </div>
                </section>
            </div>
        </div>
        <div class="row">
            <div class="col-12">
                ...
                <a class="footer-copyright__link" href="https://automarketpanama.com/politicas">Política de Privacidad</a> 
                </div>
            </div>
